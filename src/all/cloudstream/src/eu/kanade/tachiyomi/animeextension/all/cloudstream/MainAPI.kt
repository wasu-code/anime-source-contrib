...
import eu.kanade.tachiyomi.animeextension.all.cloudstream.mvvm.logError
import eu.kanade.tachiyomi.animeextension.all.cloudstream.mvvm.safe
import eu.kanade.tachiyomi.animeextension.all.cloudstream.syncproviders.SyncIdName
import eu.kanade.tachiyomi.animeextension.all.cloudstream.utils.AppUtils.toJson
import eu.kanade.tachiyomi.animeextension.all.cloudstream.utils.AppUtils.tryParseJson
import eu.kanade.tachiyomi.animeextension.all.cloudstream.utils.Coroutines.threadSafeListOf
import eu.kanade.tachiyomi.animeextension.all.cloudstream.utils.ExtractorLink
import eu.kanade.tachiyomi.animeextension.all.cloudstream.utils.app
...
fun EpisodeResponse.addSeasonNames(names: List<String>) {
    this.seasonNames = if (names.isEmpty()) {
        null
    } else names.mapIndexed { index, s ->
        SeasonData(
            season = index + 1,
            s,
        )
